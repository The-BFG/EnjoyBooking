...
class CustomUserManager(BaseUserManager):
    def create_user(self, email, password, first_name=None, last_name=None, birth_date=None, city=None, address=None, postal_code=None, avatar=None, phone=None):
        if not email:
    ...
    def create_superuser(self, email, password, first_name=None, last_name=None, birth_date=None, city=None, address=None, postal_code=None, avatar=None, phone=None):
...
def getImagePath(instance, filename):
    return "profileImage/%s/%s" % (instance.id, filename)
